...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
	    ...
	    Scene scene  = new Scene(background, 500 , 600);
		...
		background.add(new Log("file:src/p4_group_8_repo/img/log3.png", 100, 0, 166, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/img/log3.png", 100, 220, 166, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/img/log3.png", 100, 440, 166, 0.75));
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 0, 166, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/img/logs.png", 250, 0, 276, -2));
		background.add(new Log("file:src/p4_group_8_repo/img/logs.png", 250, 400, 276, -2));
		//background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 800, 276, -2));
		background.add(new Log("file:src/p4_group_8_repo/img/log3.png", 100, 50, 329, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/img/log3.png", 100, 270, 329, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/img/log3.png", 100, 490, 329, 0.75));
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 570, 329, 0.75));
		
		background.add(new Turtle(400, 376, -1, 130, 130));
		background.add(new Turtle(200, 376, -1, 130, 130));
		background.add(new WetTurtle(600, 376, -1, 130, 130));
		background.add(new WetTurtle(500, 217, -1, 130, 130));
		background.add(new WetTurtle(300, 217, -1, 130, 130));
		background.add(new WetTurtle(100, 217, -1, 130, 130));
		...
		background.add(new Obstacle("file:src/p4_group_8_repo/img/truck1"+"Right.png", 0, 649, 1, 120, 120));
		background.add(new Obstacle("file:src/p4_group_8_repo/img/truck1"+"Right.png", 300, 649, 1, 120, 120));
		background.add(new Obstacle("file:src/p4_group_8_repo/img/truck1"+"Right.png", 600, 649, 1, 120, 120));
